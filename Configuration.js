...
function getEndpoints(deviceAddress, endpoints) {
    ...
    var e = endpoints.addEndpoint("3", "Moisture", endpointType.genericSensor);
    e.variableTypeId = 1302;
    var e = endpoints.addEndpoint("4", "EC", endpointType.genericSensor);
    e.variableTypeId = 1303;
